...
setwd("C:/programs/Dropbox/CNVassoc_project/package/CNVassoc_1.5/CNVassoc/vignettes")                 
treball<-"C:/programs/Dropbox/CNVassoc_project/package/CNVassoc_1.5/CNVassoc/vignettes"
...
tools::compactPDF("../inst/doc",gs_quality = "ebook")
